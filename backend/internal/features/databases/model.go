...
type Database struct {
	...
	MysqlPhysical      *mysql_physical.MysqlPhysicalDatabase           `json:"mysqlPhysical,omitzero"      gorm:"foreignKey:DatabaseID"`
...
func (d *Database) Validate() error {
	...
	case DatabaseTypeMysqlPhysical:
		if d.MysqlPhysical == nil {
			return errors.New("mysql physical database is required")
		}
		return d.MysqlPhysical.Validate()
...
func (d *Database) ValidateUpdate(old, new Database) error {
	...
	if old.Type == DatabaseTypeMysqlPhysical && old.MysqlPhysical != nil && new.MysqlPhysical != nil {
		if err := new.MysqlPhysical.ValidateUpdate(old.MysqlPhysical); err != nil {
			return err
		}
	}
...
func (d *Database) TestConnection(
	...
	case DatabaseTypeMysqlPhysical:
		return d.MysqlPhysical.TestPhysicalConnection(logger, encryptor)
	case DatabaseTypeMariadb:
...
func (d *Database) HideSensitiveData() {
	...
	if d.MysqlPhysical != nil {
		d.MysqlPhysical.HideSensitiveData()
	}
	if d.Mariadb != nil {
...
func (d *Database) EncryptSensitiveFields(encryptor encryption.FieldEncryptor) error {
	...
	if d.MysqlPhysical != nil {
		return d.MysqlPhysical.EncryptSensitiveFields(encryptor)
	}
	if d.Mariadb != nil {
...
func (d *Database) PopulateDbData(
	...
	if d.MysqlPhysical != nil {
		return d.MysqlPhysical.PopulateDbData(logger, encryptor)
	}
	if d.Mariadb != nil {
...
func (d *Database) Update(incoming *Database) {
	...
	case DatabaseTypeMysqlPhysical:
		if d.MysqlPhysical != nil && incoming.MysqlPhysical != nil {
			d.MysqlPhysical.Update(incoming.MysqlPhysical)
		}
	case DatabaseTypeMariadb:
