...
func (s *DatabaseService) CopyDatabase(
	...
	case DatabaseTypeMysqlPhysical:
		if existingDatabase.MysqlPhysical != nil {
			newDatabase.MysqlPhysical = &mysql_physical.MysqlPhysicalDatabase{
				ID:              uuid.Nil,
				DatabaseID:      nil,
				Version:         existingDatabase.MysqlPhysical.Version,
				Host:            existingDatabase.MysqlPhysical.Host,
				Port:            existingDatabase.MysqlPhysical.Port,
				Username:        existingDatabase.MysqlPhysical.Username,
				Password:        existingDatabase.MysqlPhysical.Password,
				IsHttps:         existingDatabase.MysqlPhysical.IsHttps,
				DataDir:         existingDatabase.MysqlPhysical.DataDir,
				IsBinlogEnabled: existingDatabase.MysqlPhysical.IsBinlogEnabled,
			}
		}
