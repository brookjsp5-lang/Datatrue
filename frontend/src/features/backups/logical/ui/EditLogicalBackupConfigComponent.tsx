    ...
    <div>
      ...
      <div className="mb-1 flex w-full flex-col items-start sm:flex-row sm:items-center">
        ...
        <div className="flex w-full items-center">
          ...
          <Tooltip
            className="cursor-pointer"
            title="If backup is encrypted, backup files in your storage (S3, local, etc.) cannot be used directly. You can restore backups through Datatrue or download them unencrypted via the 'Download' button."
          >
            <InfoCircleOutlined className="ml-2" style={{ color: 'gray' }} />
          </Tooltip>
        </div>
