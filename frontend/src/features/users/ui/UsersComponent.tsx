...
import { App, Button, Drawer, Form, Input, Modal, Select, Spin, Switch, Table } from 'antd';
...
export function UsersComponent({ contentHeight }: Props) {
  ...
  const handleCreateUser = async () => {
    try {
      ...
      const isValidationError = Boolean((error as { errorFields?: unknown }).errorFields);
  ...
  return (
    <div className="flex grow">
      <div className="w-full">
        ...
        >
          <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h1 className="text-2xl font-bold dark:text-white">Datatrue users</h1>
      ...
      <Modal
        ...
        afterClose={() => createUserForm.resetFields()}
        destroyOnClose
      >
