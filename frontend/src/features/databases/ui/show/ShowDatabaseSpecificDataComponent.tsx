...
import { ShowMySqlPhysicalSpecificDataComponent } from './ShowMySqlPhysicalSpecificDataComponent';
...
export const ShowDatabaseSpecificDataComponent = ({ database }: Props) => {
  switch (database.type) {
    ...
    case DatabaseType.MYSQL_PHYSICAL:
      return <ShowMySqlPhysicalSpecificDataComponent database={database} />;
