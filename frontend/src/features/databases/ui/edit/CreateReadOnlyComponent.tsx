...
export const CreateReadOnlyComponent = ({
  ...
  return (
    <div>
      <div className="mb-5">
        <p className="mb-3 text-lg font-bold">Create a {userKindNoun} for Datatrue?</p>
        ...
        <p className="mb-2">
          Datatrue enforces enterprise-grade security (
          <a
      ...
      >
        <div className="mb-5">
          ...
          <p className="mb-2">
            ...
            risks. Datatrue highly recommends that you do not skip this step.
          </p>
