  ...
  return (
    <div className="flex grow">
      <div className="w-full">
        ...
        >
          <h1 className="text-2xl font-bold dark:text-white">Datatrue settings</h1>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 pb-4 dark:border-gray-700">
                    ...
                    <div className="mt-1 text-gray-500 dark:text-gray-400">
                      Administrators create users from the Datatrue users page. New users cannot
                      create their own accounts from the sign-in screen.
                    </div>
                  </div>
